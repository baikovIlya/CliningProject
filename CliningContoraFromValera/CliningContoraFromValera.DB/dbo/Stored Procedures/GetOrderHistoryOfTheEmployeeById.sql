...
BEGIN
	...
	C.Email, C.Phone, A.Id, A.Street, A.Building, A.Room, A.WorkAreaId, W.Id, W.[Name], S.Id, S.[Name], S.[Description], S.Price,
    S.CommercialPrice, S.Unit, S.ServiceTypeId, S.EstimatedTime FROM [dbo].[Employee] AS E
