...
BEGIN
	...
	C.Email, C.Phone, A.Id, A.Street, A.Building, A.Room, A.WorkAreaId, W.Id, W.[Name], S.Id, S.ServiceType, S.[Name],
	S.[Description], S.Price, S.CommercialPrice, S.Unit, S.EstimatedTime, SO.Id, SO.OrderId, SO.ServiceId, SO.[Count] FROM [dbo].[Employee] AS E
