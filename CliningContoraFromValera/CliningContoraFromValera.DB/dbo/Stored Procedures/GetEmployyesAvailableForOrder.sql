...
AS
BEGIN
	  SELECT E.Id, FirstName, E.LastName, E.Phone, WT.Id, WT.[Date], WT.StartTime, WT.FinishTime, WT.EmployeeId,
      ...
      WHERE E.IsDeleted = 0 AND WT.IsDeleted = 0 AND S.IsDeleted = 0 AND
